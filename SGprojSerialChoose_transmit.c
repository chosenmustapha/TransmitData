...
// Example: 1 Second Delay with 4 MHz clock
// Instruction period = 4 * 0.25usec = 1 usec
// with prescale of 32, 32 * 1 usec = 32 usec
...
// INITIALIZE INTERNAL CLOCK TO 4 MHZ
...
// PIN ASSIGNMENTS
 ...
 // SET UP SERIAL COMMUNICATION USART

   SPBRG = 22;         		 // Set Up for 9.6 Baud serial comm
   BAUDCONbits.BRG16 = 0;  	 // Use 16-bit reg for SPBRG
   TXSTAbits.BRGH = 1;       // Select high baud rate
   
   BAUDCONbits.TXCKP = 0;    // TX is high when idle   
...
//SET UP TIMER 0   
    ...
    //Initialize Timer - Set Prescale to divide by 32
